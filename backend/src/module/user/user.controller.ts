...
Please use the following verification url to verify your account: ${config.clientUrl}/accounts-admin-portal/verify-account?code=${result.verifiedCode}
`;
...
Please use the following url to forget password: ${config.clientUrl}/accounts-admin-portal/forget-password?code=${forgetCode}
`;
