      ...
      cell: ({ row }) => (
        <div className="flex gap-3">
          {getPermission("Voucher", "read") && (
            <Link
              to={`/accounts-admin-portal/view-journal-voucher/${row.original.id}`}
            >
              <Button
                variant="outline"
          ...
          {getPermission("Voucher", "update") && (
            <Link
              to={`/accounts-admin-portal/edit-journal-voucher/${row.original.id}`}
            >
              <Button
                variant="outline"
                className="bg-gray-100"
  ...
  return (
    <div className="p-4 min-h-screen space-y-4">
      ...
      <ReusableTableHeader
        ...
        createButtonLink="/accounts-admin-portal/create-journal-voucher"
