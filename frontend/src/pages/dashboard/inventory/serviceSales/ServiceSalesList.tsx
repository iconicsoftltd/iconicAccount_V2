...
import { useDeleteServiceSalesMutation, useGetAllServiceSalesQuery } from "@/components/store/api/inventory/serviceSales/serviceSalesApi";
...
const ServiceSalesList: React.FC = () => {
  ...
  const [deleteSale, { isLoading: isDeleting }] = useDeleteServiceSalesMutation();
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              size="icon"
              onClick={() =>
                navigate(`/accounts-admin-portal/service-sales?id=${item.id}`)
              }
            >
              <FaRegEdit />
            </Button>
  ...
  return (
    <div className="p-4 min-h-screen space-y-4">
      <ReusableTableHeader
        ...
        createButtonLink="/accounts-admin-portal/service-sales"
